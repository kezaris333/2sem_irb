#include <iostream>
#include <cstring>
#include <C:\Users\мина\Desktop\codes\binomial_priority\priority_queue.h>
...
public:
    ...
    priority_queue* meld(priority_queue const* with)  override; //слияние без униточжения изначальных объектов
